...
public class PlayerVersus1 : MonoBehaviour
{
    ...
    public static PlayerVersus1 current;
    ...
    void Update()
    {
     ...
     {   
        ...
        {
            if(Input.GetKeyDown(KeyCode.M) && (PlayerVersus.current.GetComponent<Rigidbody2D>().bodyType == RigidbodyType2D.Dynamic) )
            {
                //AudioPunch.Play();
