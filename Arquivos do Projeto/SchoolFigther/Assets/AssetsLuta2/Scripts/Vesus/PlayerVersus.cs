...
public class PlayerVersus : MonoBehaviour
{
    ...
    public static PlayerVersus current;
    ...
    void Update()
    {
        ...
        if ((!isDead) && (!Player2Versus.current.isDead) && (Time.timeScale == 1))
        {


            if ((Input.GetKey(KeyCode.RightArrow)) && (!isDefense) && (isAtk == false) && (ControlVersus.current.canPlay == true) && (!isPower) && (!Player2Versus.current.isDead) && (Player2Versus.current.GetComponent<Player2Versus>().enabled))
            {
            ...
            if ((Input.GetKey(KeyCode.LeftArrow)) && (!isDefense) && (isAtk == false) && (ControlVersus.current.canPlay == true) && (!isPower) && (!Player2Versus.current.isDead) && (Player2Versus.current.GetComponent<Player2Versus>().enabled))
            {
                rig.velocity = new Vector2(-Speed * Time.deltaTime, rig.velocity.y);
                anim.SetBool("isWalking", true);
            ...
            {
                if (Input.GetKeyDown(KeyCode.Keypad4) && (Player2Versus.current.GetComponent<Rigidbody2D>().bodyType == RigidbodyType2D.Dynamic))
                {
                    //AudioPunch.Play();
